...
export class EnemyCylinderBombDestroyEffect extends DisposableSceneEffect {
    ...
    public apply(parent: Nullable<Mesh | TransformNode> = null): void {
        ...
        cubes?.applySmallExplosion(parent, "black", "very-very-small");
    }
}
