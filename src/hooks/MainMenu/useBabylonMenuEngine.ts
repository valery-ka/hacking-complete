...
const BACKGROUND_COLOR = { r: 0.77, g: 0.74, b: 0.64, a: 1.0 };

export const useBabylonMenuEngine = ({ engineCanvasRef }: IUseBabylonEngine) => {
    ...
    useEffect(() => {
        ...
        breadcrumb("menu.engine.attached");

        const scene = new Scene(engine);
        const camera = new FreeCamera("main-menu-camera", new Vector3(0, 0, 0), scene);
