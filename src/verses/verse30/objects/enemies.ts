...
export const enemies: EnemyConfig[] = [
    {
        ...
        enemy_type: "cylinder",
        on_spawn: { position: { x: -5, y: 10.85, z: 0 }, rotation_y: Math.PI, hp: 3 },
...

    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -10, y: 10.85, z: 1 }, rotation_y: Math.PI, hp: 2 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
...

    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -11, y: 10.85, z: 6 }, rotation_y: Math.PI, hp: 2 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
...

    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -4.5, y: 10.85, z: 8 }, rotation_y: Math.PI, hp: 2 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
...

    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 0, y: 10.85, z: 10 }, rotation_y: Math.PI, hp: 2, delay: 3.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -10, y: 10.85, z: -2 }, rotation_y: Math.PI, hp: 2, delay: 4.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 10, y: 10.85, z: -2 }, rotation_y: Math.PI, hp: 2, delay: 5.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 0, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 0, y: 10.85, z: 7 }, rotation_y: Math.PI, hp: 2, delay: 6.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    // CORE
    {
        ...
        shooter: {
            ...
            initial_delay: 250,
            cooldown: 1000,
            cooldown_dynamic: [100, 200, 200, 300, 300, 400, 400, 500, 500, 600, 600, 700, 700],
            directions: generateDirections(2),
            spreading: 0.0001,
            pattern: [
                [0, 1, 0],
