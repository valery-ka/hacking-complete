...
export const enemies: EnemyConfig[] = [
    // Cylinders
    {
        ...
        enemy_type: "cylinder",
        on_spawn: { position: { x: -13.5, y: 10.85, z: 0 }, rotation_y: Math.PI, hp: 3 },
    ...
    //
    {
        ...
        enemy_type: "arrow",
        on_spawn: { position: { x: -7.5, y: 10.85, z: 4 }, rotation_y: Math.PI, hp: 2 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -3.5, y: 10.85, z: 7 }, rotation_y: Math.PI, hp: 2 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 3.5, y: 10.85, z: -1 }, rotation_y: Math.PI, hp: 2, delay: 5.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 3.5, y: 10.85, z: 1 }, rotation_y: Math.PI, hp: 2, delay: 6.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -3, y: 10.85, z: 6 }, rotation_y: Math.PI, hp: 2, delay: 10.66 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: -9, y: 10.85, z: 6 }, rotation_y: Math.PI, hp: 2, delay: 11.66 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 3, y: 10.85, z: 6 }, rotation_y: Math.PI, hp: 2, delay: 12.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
    ...
    },
    {
        trigger: { pool: { self: 20, to_trigger: 100 } },
        enemy_type: "arrow",
        on_spawn: { position: { x: 9, y: 10.85, z: 6 }, rotation_y: Math.PI, hp: 2, delay: 11.0 },
        ground: { id: 0, physics: "plane", size: HEIGHT },
        is_inside_ground: false,
        follow_player: { enabled: true, speed: 2.0 },
        triggers_by_player: [true, false],
